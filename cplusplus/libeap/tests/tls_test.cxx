...
/*                                                                        */
/* END_COPYRIGHT                                                          */
// $Id: tls_test.cxx,v 1.5 2004/07/05 10:10:20 canelaman Exp $ 
...
/*
  ...
  *with* a passthrough authenticator in between.
  ...
  All cases completes with success after EAP-TLS authentication
  ...
  carried in an Response/TLS-Response message and sent to the
  ...
  Request/Tls-Request message until you input the username or the
...
class MyEapPeerTlsStateMachine : public EapPeerTlsStateMachine
{
...
class PeerApplication : public AAA_JobData
{
 public:
  PeerApplication(EapTask &task, ACE_Semaphore &sem) : 
    ...
    txChannel(0),
    method(EapContinuedPolicyElement(EapType(TLS_METHOD_TYPE)))
  {
