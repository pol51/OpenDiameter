...
/* 
   ...
   Definition of the Diameter interface to the MIP 4 Application, for FA 
   Client session.
...
#ifndef __MIP4_DIAMETER_FA_CLIENT_INTERFACE_H__
#define __MIP4_DIAMETER_FA_CLIENT_INTERFACE_H__

#include "diameter_api.h"

class Mip4DiameterFaClientInterface {
public:
  //Ideally  RxMipRegReq() should have been a pure virtual class since it
  // needs an implementation in DiameterMip4FaClientSession, but we could not
  // solve a compiler error complaining about 
  // Mip4DiameterFaClientInterface::RxMipRegReq(diameter_octetstring_t&) being 
  ...
  virtual ~Mip4DiameterFaClientInterface(){}

};

#endif //__MIP4_DIAMETER_FA_CLIENT_INTERFACE_H__
